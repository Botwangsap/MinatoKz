...
module.exports = async(conn, msg, m, setting, store, welcome, _afk) => {
          try {
                ...
                const buttonsDefault = [
                   { urlButton: { displayText: `My instagram`, url: setting.sosmed.youtube } },
        ...
        switch(command) {
                ...
                case prefix+'help':
                   ...
                   conn.sendMessage(from, { location: { jpegThumbnail: await reSize(fs.readFileSync(setting.pathimg), 300, 170) }, caption: teks, mentions: [sender], footer: setting.footer, templateButtons: buttonsDefault }, { quoted: msg })
                   break
                case prefix+'runtime':
